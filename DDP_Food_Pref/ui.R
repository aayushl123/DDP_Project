...
shinyUI(
        pageWithSidebar(
                ...
                sidebarPanel(
                        ...
                        br(),
                        p(strong(em("Documentation:",a("Food Preferences",href="index.html")))),
                        p(strong(em("Github repository:",a("Developing Data Products - Peer Assessment Project; Shiny App",href="https://github.com/Sana-Rasheed/DDP_Project"))))
